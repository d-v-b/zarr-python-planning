"""Default pure-Python engine for Zarr-Python v4.
...
class PythonEngine:
    """The default pure-Python engine implementing :class:`Engine`.
    ...
    def read_chunk(
        ...
        """Read and decode a single chunk in pure Python.
    ...
    def read_selection(
        ...
        """Read and decode an arbitrary selection in pure Python.
    ...
    def write_chunk(
        ...
        """Encode and write a single chunk in pure Python.
    ...
    def write_selection(
        ...
        """Encode and write an arbitrary selection in pure Python.
